        ...
        <div className="relative mb-6 mx-auto w-36 h-52 overflow-hidden bg-gray-900">
          ...
          {member.image ? (
            <Image
              ...
              alt={member.name}
              fill
              className={`object-cover transition-all duration-300 ${isHovered ? "scale-105 brightness-110 contrast-125" : "grayscale-[30%]"
                }`}
          ...
          {isHovered && (
            <>
              <div className="absolute inset-0 bg-red-500/20 mix-blend-multiply animate-pulse z-10"></div>
              <div className="absolute inset-0 bg-blue-500/10 mix-blend-screen animate-ping z-10"></div>
            </>
          )}
