...
import KrampSectionDivider from "./KrampSectionDivider";
...
export default function KrampSections({ lang, dict }: KrampSectionsProps) {
  return (
    <>
      ...
      <section id="soundtrack" className="py-20 relative z-10 bg-gradient-to-b from-black via-green-950/10 to-black scroll-mt-36">
        <div className="fm-shell max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 font-rajdhani text-lg">
              {dict.soundtrack?.description || 'Festive synthwave for deeper immersion into holiday horror.'}
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2">
              <KrampAudioPlayer labels={dict.soundtrack} />
            </div>
            
            {/* SFX Panel */}
            <div className="md:col-span-1">
              <KrampSFXPanel labels={dict.soundtrack?.sfx} />
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              ...
              {dict.soundtrack?.listenStreaming || 'Listen on Streaming'}
            </a>
          </div>
          ...
          <div className="max-w-4xl mx-auto mt-8">
            <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
              <iframe
                ...
                title={dict.soundtrack?.youtubeIframeTitle || "KRAMP.EXE soundtrack on YouTube"}
            ...
            <p className="text-center text-green-600 text-sm mt-2 font-mono">
              {dict.soundtrack?.youtubeFooter || '▲ FULL PLAYLIST ON YOUTUBE ▲'}
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="tables" className="py-20 relative z-10 bg-black scroll-mt-36">
        <div className="fm-shell max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 font-rajdhani text-lg">
              {dict.tables?.description || 'Roll the dice to spark your imagination during the game.'}
            </p>
          </div>
          
          <KrampTerminalTables lang={lang} labels={dict.tables} />
        </div>
      </section>
    </>
  );
