    ...
    <section id="playtest" className="scroll-mt-36 border-t border-[#505c64] bg-[#18213c] py-20">
      <div className="fm-shell max-w-5xl">
        <div className="expedition-fade-up relative overflow-hidden border border-[#f67b40] bg-[#202b49] px-4 py-6 shadow-[5px_5px_0_0_rgba(236,84,76,0.4)] sm:px-6 sm:py-8 sm:shadow-[8px_8px_0_0_rgba(236,84,76,0.4)] md:px-10 md:py-10">
          ...
          <h2 className="relative mb-4 text-3xl uppercase text-[#f5efe0] [font-family:var(--font-exp-heading)] sm:text-4xl">{dict.nav.playtest}</h2>
          ...
          <div className="relative mt-8 border border-[#c6d9c6]/55 bg-[#18213c]/70 p-4 sm:p-6">
            <p className="text-[10px] uppercase tracking-[0.2em] text-[#f7a37a] [font-family:var(--font-exp-ui)] sm:text-xs">{dict.playtest.portal.overline}</p>
            <h3 className="mt-3 text-2xl uppercase text-[#f5efe0] [font-family:var(--font-exp-heading)] sm:text-3xl">{dict.playtest.portal.title}</h3>
            <p className="mt-3 max-w-[44ch] text-base leading-relaxed text-[#d9e7d9] [font-family:var(--font-exp-body)] sm:text-lg">{dict.playtest.portal.description}</p>
            <a
              href="https://expedition418.com"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 inline-flex min-h-12 items-center justify-center border border-[#f67b40] bg-[#f67b40] px-5 py-3 text-sm uppercase tracking-[0.1em] text-[#18213c] transition-colors hover:bg-[#ec544c] hover:text-[#f5efe0] [font-family:var(--font-exp-heading)] sm:text-base"
            >
              {dict.playtest.portal.button}
            </a>
          </div>
          ...
          <div className="relative mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
            ...
            >
              {dict.playtest.buttons.telegram}
            </a>
            <a
            ...
            <a
              href="https://fablesmonster.itch.io/expedition-418"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-12 items-center justify-center border border-[#f67b40] bg-[#f67b40] px-5 py-3 text-base uppercase tracking-[0.08em] text-[#18213c] transition-colors hover:bg-[#ec544c] hover:text-[#f5efe0] [font-family:var(--font-exp-heading)]"
            >
              {dict.playtest.buttons.itch}
            </a>
            <Link
