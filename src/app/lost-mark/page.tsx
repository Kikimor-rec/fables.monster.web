        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center">
            <div>
              ...
              <p className="text-base sm:text-lg text-gray-300 mb-4 sm:mb-6 font-mono">
              ...
              <div className="bg-black border border-red-700 p-4 sm:p-6 mb-4 sm:mb-6">
                <h3 className="text-lg sm:text-xl font-bold text-white mb-2 sm:mb-4 font-mono">CREDITS</h3>
            ...
            <div className="flex flex-col items-center w-full">
              ...
              <div className="w-full max-w-full sm:max-w-[400px] md:max-w-[500px] lg:max-w-[600px] bg-red-950/20 border-2 border-red-700 p-4 sm:p-6">
                <div className="text-white font-mono font-bold text-lg sm:text-xl mb-2 text-center">
                  ⚠ WARNING
                </div>
                <div className="text-gray-300 font-mono text-xs sm:text-sm text-center">
