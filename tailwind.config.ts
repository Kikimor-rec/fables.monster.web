  ...
  theme: {
    extend: {
      colors: {
        ...
        "space-dark": "#0a0a0f",
        "space-darker": "#050508",
        // Expedition-418 palette
        "exp-accent": "var(--exp-accent)",
        "exp-accent-alt": "var(--exp-accent-alt)",
        "exp-bg": "var(--exp-bg)",
        "exp-bg-alt": "var(--exp-bg-alt)",
        "exp-border": "var(--exp-border)",
        "exp-text-primary": "var(--exp-text-primary)",
        "exp-text-secondary": "var(--exp-text-secondary)",
        "exp-text-muted": "var(--exp-text-muted)",
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        "glow-exp": "0 0 20px rgba(255, 104, 61, 0.5), 0 0 40px rgba(255, 104, 61, 0.3)",
